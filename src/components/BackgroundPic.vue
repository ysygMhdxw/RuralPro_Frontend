<template>
  <div class="block" style="height:100%;margin: 0px;padding: 0px;width: 100%">
    <div style="position: absolute;z-index:2;left: 20px;top: 30px">
      <div >
...
export default {
  ...
  data(){
    return{
     src:require("../assets/img/ECNU_pic.jpg"),
    }
  },
  mounted() {
    this.searchbar();
